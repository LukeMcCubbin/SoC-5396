...
void temp_sseg(I2cCore *adt7420_p, GpoCore *led_p, SsegCore *sseg_p, GpiCore *sw_p) {
   ...
   //display array on sseg
   for(i = 0; i < 4; i++){
		sseg_p->write_1ptn(sseg_p->h2s(var[i]), 3 - i);
   }
   s = 0;
