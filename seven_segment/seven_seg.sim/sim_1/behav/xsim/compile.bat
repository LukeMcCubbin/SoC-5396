...
REM
REM Generated by Vivado on Tue Sep 05 23:26:13 -0500 2023
...
echo "xvlog --incr --relax -L uvm -prj hex7seg_vlog.prj"
call xvlog  --incr --relax -L uvm -prj hex7seg_vlog.prj -log xvlog.log
